...
class TraceGraphService:
    ...
    def _serialize_result(result, normalized_document_ids):
        ...
        return {
            ...
            "query_embedding_latency_ms": result.get("query_embedding_latency_ms"),
            "hybrid_probe_latency_ms": result.get("hybrid_probe_latency_ms"),
            "graph_probe_latency_ms": result.get("graph_probe_latency_ms"),
            "reranker_latency_ms": result.get("reranker_latency_ms"),
            "reranker_input_count": result.get("reranker_input_count"),
            "reranker_total_chars": result.get("reranker_total_chars"),
            "reranker_max_chars": result.get("reranker_max_chars"),
